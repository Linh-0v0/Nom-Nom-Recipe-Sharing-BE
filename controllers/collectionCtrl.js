...
collectionCtrl.getCollectionByName = async (req, res) => {
  ...
  try {
    const collection = await db.any('SELECT * FROM collection WHERE name ILIKE $1 AND user_id = $2', [`%${name}%`, userId]);
...
collectionCtrl.getCollectionById = async (req, res) => {
  ...
  try {
    const collection = await db.one('SELECT * FROM collection WHERE collection_id = $1 AND user_id = $2', [id, userId]);
...
collectionCtrl.addRecipe = async (req, res) => {
  ...
  try {
    ...
    const selectCollectionQuery = 'SELECT user_id FROM collection WHERE collection_id = $1';
    const selectCollectionValues = [collection_id];
    const selectCollectionResult = await db.query(selectCollectionQuery, selectCollectionValues);
...
collectionCtrl.updateCollection = async (req, res) => {
  ...
  try {
    ...
    const updateCollectionQuery = 'UPDATE collection SET name = $1, note = $2 WHERE collection_id = $3';
...
collectionCtrl.removeCollection = async (req, res) => {
  ...
  try {
    ...
    const selectCollectionResult = await client.query(selectCollectionQuery, selectCollectionValues);
    ...
    const deleteCollectionRecipeQuery = 'DELETE FROM collection_recipe WHERE collection_id = $1';
    const deleteCollectionRecipeValues = [collectionId];
    await client.query(deleteCollectionRecipeQuery, deleteCollectionRecipeValues);

    // Delete the collection
    const deleteCollectionQuery = 'DELETE FROM collection WHERE collection_id = $1';
